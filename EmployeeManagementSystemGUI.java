...
public class EmployeeManagementSystemGUI {
 ...
 public boolean login(String username, String password) throws SQLException {
     ...
     if(resultSet.next()){
         if(resultSet.getString(1).equals(password)){
             ...
             popup.getContentPane().setBackground(new Color(135, 206, 235));
 ...
 public void viewEmployee() throws SQLException {
     ...
     while (resultSet.next()) {
         ...
         employeeCard.setBackground(new Color(135, 206, 235));
 ...
 public void addEmployee() throws SQLException  {
     ...
     submitButton.setBackground(clr);
 ...
 public void mainMenu(){
     ...
     menuFrame.getContentPane().setBackground(new Color(135, 206, 235));
     ...
     viewEmpButton.setBackground(clr);
     ...
     addEmpButton.setBackground(clr);
     ...
     editEmpButton.setBackground(clr);
     ...
     deleteEmpButton.setBackground(clr);
 ...
 static Color clr = new Color(0, 128, 128);
//submitButton.setBackground(new Color(211, 211, 211));
 public static void main(String[] args) throws SQLException, ClassNotFoundException {
     ...
     ems.loginFrame.getContentPane().setBackground(new Color(135, 206, 235));
